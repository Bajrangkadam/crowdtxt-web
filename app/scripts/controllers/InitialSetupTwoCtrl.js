...
(function () {
    ...
    var module = angular.module(
        'ct.controllers.initialSetupTwo',
        []
    );

    module.controller('InitialSetupTwoCtrl',
        ['$rootScope', '$scope', '$location', '$http', '$timeout', '$upload', '$cookieStore',
        

    function InitialSetupTwoCtrl($rootScope, $scope, $location, $http, $timeout, $upload, $cookieStore) {
        ...
        //alert("help");
        console.log('InitialSetupTwoCtrl module is called..');
...
// =================================== Hide and show initialsetup pages.. ======================================
                                    ...
                                    $scope.gotoStep3 = function(){
                                      ...
                                      if($scope.numberOfGroups<=0){

                                         $(".alteastOneGroup").show(); // To show Toast Notification when clicked on delete..
                                           window.setTimeout(function() {
                                            $(".alteastOneGroup").hide();
                                          },3000)
...
// =============================================================================================================
     ...
     // -------------------------- Funtion to refresh the list.. ----------------------------
                        ...
                                 listGroup.success(function (data, status, response) {
                          ...
                          $scope.numberOfGroups = $scope.groupDetails.length;

                           window.localStorage['numberOfGroups'] = $scope.numberOfGroups;

                          console.log($scope.numberOfGroups);
                  ...
                  if ($scope.myformGroup.$valid) {
                    ...
                    //   }
                      ...
                      // $scope.groups.push({groupName: $scope.newGroup, purpose: $scope.groupPurpose, status:$scope.user.roles});
                       ...
                       console.log("jkjkljkljk",$scope.result);
                         ...
                         if($scope.result.id==2){
                          ...
                          console.log("jkhkhhhhhjjjjjjj",$scope.mobileNoss);

                          if($scope.mobileNoss==undefined){
                              var groupJson2={
                                          "groupName":$scope.newGroup,
                                          "purpose":$scope.groupPurpose,
                                          "isPublic":publicValue,
        ...
        // ================================================= Model window validation ============================================================
                ...
                $scope.editPrivateUserss = function(){


                   
                                          var privateuserNames = /^[a-zA-Z ]*$/;
                                          var privateemailIdvalidation = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
                                          var privatemobilePattern = /^$|^(?:1-?)?[(]?\d{3}[)]?\s?-?\s?\d{3}\s?-?\s?\d{4}$/;

                                         var privateUserfirstName = document.getElementById("privateUserfirstName").value;
                                         var privateUserlastName = document.getElementById("privateUserlastName").value;
                                         var privateUseremailid = document.getElementById("privateUseremailid").value;
                                         var privateUserphone = document.getElementById("privateUserphone").value;
                                          

                                         $scope.privatefirstName = false;
                                         $scope.privatelastName = false;
                                         $scope.privateEmail = false;
                                         $scope.privatemobile = false;



                                      if (privateUserfirstName == "" || !privateuserNames.test(privateUserfirstName)) {
                                          $scope.privatefirstName = true;
                                        
                                        } else if (privateUserlastName == "" || !privateuserNames.test(privateUserlastName)) {
                                            $scope.privatelastName = true;

                                        } else if (privateUseremailid == "" || !privateemailIdvalidation.test(privateUseremailid)) {
                                            $scope.privateEmail = true;
                                          // } else if (mobileNop == "") {

                                        } else if (!privatemobilePattern.test(privateUserphone)) {
                                            $scope.privatemobile = true;

                                        } else {

                                        
                                            console.log("jjjjjj________",$scope.edit);

                                            setTimeout(function(){ angular.element('.savePrivateUserss').trigger('click'); }, 200);
    ...
    // -------------------- Step 2 add and list new user.. -------------------- 
                                      ...
                                      $scope.addPrivateUsers = function () {
                                       ...
                                       // alert();
                                          ...
                                          var emailIdvalidation = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
                                      ...
                                      if (firstNamep == "" || !userNames.test(firstNamep)) {
                                          $scope.firstNamepMsg = true;

                                        } else if (lastNamep == "" || !userNames.test(lastNamep)) {
                                            $scope.lastNamepMsg = true;

                                        } else if (emailp == "" || !emailIdvalidation.test(emailp)) {
                                            $scope.emailpMsg = true;
                                         
                                        } else if (!mobilePattern.test(mobileNop)) {
...
// ======================================================================================================
                        ...
                                              }
                                          })
                                    limiteduserss.success(function (data, status, response) {
